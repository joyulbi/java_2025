        ...
        <tbody>
          <c:forEach var="dto" items="${list}" varStatus="state">
             <tr>
                ...
                <td>
                   <a href="${pageContext.request.contextPath}/board/detail/${dto.id}">
                      ${dto.btitle}
                   </a>
                </td>
            ...
            <tr>
                <td colspan="5">
                  ...
                  <c:if test="${paging.start >= paging.bottomlist}">
                     <li class="page-item">
                        <a class="page-link" href="${pageContext.request.contextPath}/board/list?page=${paging.start-2}">이전</a>
                     </li>
                  </c:if>
                  
                  <c:forEach begin="${paging.start}" end="${paging.end}" var="i">
                     <li class="page-item ${paging.current == i ? 'active' : ''}">
                        <a class="page-link" href="${pageContext.request.contextPath}/board/list?page=${i-1}">${i}</a>
                     </li>
                  </c:forEach>
                  
                  <c:if test="${paging.pagetotal > paging.end}">
                     <li class="page-item">
                        <a class="page-link" href="${pageContext.request.contextPath}/board/list?page=${paging.end}">다음</a>
                     </li>
                  </c:if>
                    </ul>      
                </td>
