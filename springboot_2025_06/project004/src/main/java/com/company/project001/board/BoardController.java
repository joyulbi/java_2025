...
import com.company.project001.board.PagingDto;
...
public class BoardController {
   ...
   public String insert_post(
               Model model, RedirectAttributes rttr, MultipartFile file,
               Principal principal, @Valid BoardForm boardForm,
   ...
   public String update_get(Principal principal, Model model) {
      return "board/write";
   }
   
   @PostMapping("/board/update")
   public String update_post(Principal principal) {
      return "board/list";
   }
   
   
   @GetMapping("/board/delete/{id}")
   public String delete_get(Principal principal, Model model) {
      return "board/write";
   }
   
   @PostMapping("/board/delete/{id}")
   public String delete_post(Principal principal) {
      return "board/list";
   }
}
